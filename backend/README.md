...
# or for SQLite: DATABASE_URL=sqlite:///./data/findmygap.db
...
docker build -f Dockerfile -t findmygap-backend:latest .
...
docker exec findmygap_postgres_dev pg_isready -U postgres
