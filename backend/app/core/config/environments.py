...
class DevelopmentSettings(Settings):
    ...
    database_url: str = "postgresql://postgres:postgres@localhost:5432/findmygap_dev"
...
class StagingSettings(Settings):
    ...
    database_url: str = "postgresql://postgres:postgres@localhost:5432/findmygap_staging"
    ...
    cors_origins: list[str] = [
        "https://staging.findmygap.com",
        "https://findmygap-staging.vercel.app",
    ]
...
class ProductionSettings(Settings):
    ...
    log_level: str = "INFO"
    structured_logging: bool = True
    log_file: Optional[str] = "/var/log/findmygap/app.log"
