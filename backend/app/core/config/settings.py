...
class Settings(BaseSettings):
    ...
    database_url: Optional[str] = Field(
        default="postgresql://postgres:postgres@localhost:5432/findmygap",
    ...
    kafka_group_id: str = Field(default="findmygap_backend", description="Kafka consumer group ID")
    ...
    default_model: str = Field(default="claude-4-sonnet", description="Default LLM model")
    ...
    # Agent Configuration
    use_agno_agents: bool = Field(default=False, description="Enable Agno agents")
    ...
    pinecone_index_name: str = Field(default="findmygap-memory", description="Pinecone index name")
