...
doc_researcher_agent = Agent(
    ...
    tools=[BraveSearchTools(api_key=SETTINGS.BRAVE_API_KEY)],
    knowledge=knowledge,
...
response =customer_support_team.run(
...
stream=True, stream_intermediate_steps=True, stream_member_events=True)
